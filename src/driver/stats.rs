...
impl Stats {
    ...
    pub fn dump(&self) {
        ...
        println!("{:<20} | {:<11} | {:<11} | {:<11} | {:<11} | {:<11}", "Stat", "Count", "Sum", "Min", "Max", "Mean");
        println!("{:-<20} | {:-<11} | {:-<11} | {:-<11} | {:-<11} | {:-<11}", "", "", "", "", "", "");
        ...
        for stat in stats {
            ...
            if self.times.contains(&stat) {
                ...
                println!("{:<20} | {:>11} | {:>11.6} | {:>11.6} | {:>11.6} | {:>11.6} ", stat, cnt, sum_time, min_time, max_time, mean_time);
            }
            else {
                let mean = if *cnt != 0 { (*sum as f64) / (*cnt as f64) } else { 0 as f64 };
                println!("{:<20} | {:>11} | {:>11} | {:>11} | {:>11} | {:>11.2}", stat, cnt, sum, min, max, mean);
            }
        }
    }
}
